...
class StudyForm(FlaskForm):
    ...
    ethics_approval_exists = BooleanField(
        ...
        default=False)
    ethics_approval_no = StringField('Ethics/IRB approval number',
                                     description="If know, please specify the reference number for the Ethics/IRB  approval.")

    study_types = SelectMultipleField('Study features(s)', validators=[DataRequired()],
...
class SubmissionForm(FlaskForm):
    ...
    provider_user_ids = SelectMultipleField('Submitting users',
                                            description="Please select the list of users who will be able to view and update the submission.",
                                            coerce=int)

    submission_scope_code = SelectField('Recipient lab',
    ...
    submission_contacts = FieldList(FormField(ContactForm, default=lambda: Contact()), min_entries=3, description="You must provide at least three contacts. (1) Main contact who is the signatory on the submission info sheet, another (2) Data protection officer of the submitting institution\
...
class DatadecForm(FlaskForm):
    ...
    study_id = SelectField('Source study', coerce=int,
    ...
    gdpr_datatypes = SelectMultipleField('GDPR Personal data categories in the dataset',
    ...
    de_identification_type_code = SelectField('Is the DATA anonymised or pseudonymised?',
                                              ...
                                              validators=[DataRequired()])
    has_samples = BooleanField('Includes Samples',
    ...
    legal_basis_sharing_spec_code = SelectField(
        ...
        description="You may get assistance from your institute’s DPO or legal team in filling out this field.",
        validators=[DataRequired()])
    legal_basis_notes = StringField('Remarks on legal basis.',
    ...
    subject_category_code = SelectField('The dataset is related to the following categories of data subjects',

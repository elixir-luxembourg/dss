...
class Contact(db.Model):
    ...
    study_id = db.Column(
        db.Integer, db.ForeignKey("submission_study.id", ondelete="CASCADE"), index=True
    )
    study = db.relationship("SubmissionStudy", back_populates="study_contacts")

    submission_id = db.Column(
        db.Integer, db.ForeignKey("submissions.id", ondelete="CASCADE"), index=True
    )
...
class SubmissionDataset(db.Model):
    ...
    study_id = db.Column(
        db.Integer,
        db.ForeignKey("submission_study.id", ondelete="SET NULL"),
        nullable=True,
        index=True,
    )

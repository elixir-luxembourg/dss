...
def init_db():
    ...
    db.session.add(User(first_name='Pinar2', last_name='Alper2', elixir_sub_id='a2ba8f4043649f46c91b895e8568d8b96d985284@elixir-europe.org', email='pinarpink@googlemail.com',
